...
var h_planner = require('./html_planner');
var h_admin = require('./html_admin');
var h_doctor = require('./html_doctor');
var h_patient = require('./html_patient');
...
<div class="container">															\
 <div class="row">															\
  ...
  <div class="col-xs-12 col-sm-3 col-md-2">												\
		...
		<a class="btn btn-primary enlace-cert" href="https://'+'127.0.0.1'+":"+config.puerto_serv_cert.toString()+'/admin"> 	\
 			'+funciones.texto(req,res,"certificado_admin")+'</a>								\
		<a class="btn btn-primary enlace-cert" href="https://'+'127.0.0.1'+":"+config.puerto_serv_cert.toString()+'/patient">	\
 			'+funciones.texto(req,res,"certificado_patient")+'</a>								\
		<a class="btn btn-primary enlace-cert" href="https://'+'127.0.0.1'+":"+config.puerto_serv_cert.toString()+'/doctor"> 	\
 			'+funciones.texto(req,res,"certificado_doctor")+'</a>								\
		<a class="btn btn-primary enlace-cert" href="https://'+'127.0.0.1'+":"+config.puerto_serv_cert.toString()+'/planner">	\
...
<script>																\
	var enlaces = document.getElementsByClassName("enlace-cert");									\
	for (var i = 0; i < enlaces.length; i++) {											\
		enlaces[i].hostname = location.hostname;										\
	};																\
</script>'; 
	callback(texto_anterior+texto);
};
